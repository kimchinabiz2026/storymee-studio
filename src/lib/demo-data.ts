...
export const ips: IP[] = [
  ...
  },
  {
    ...
    characters: [
      ...
      { name: { vi: 'Cô Thảo', en: 'Cô Thảo' }, role: 'Chủ của Ú', bio: { vi: 'Người phụ nữ yêu động vật, luôn phải đau đầu giải quyết những rắc rối do Ú gây ra.', en: 'A woman who loves animals, always having a headache solving the troubles Ú causes.' }, gradient: 'linear-gradient(135deg, #e91e63, #ff6090)', image: '/assets/corgi/thao.jpg' },
